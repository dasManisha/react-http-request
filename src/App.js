...
function App() {
  ...
  function onCreateUser(user){
    ...
    if(!editMode){
      axios.post('https://react-http-tutorial-2529c-default-rtdb.firebaseio.com//users.json', user)
      .then((response) => {
      ...
      axios.put('https://react-http-tutorial-2529c-default-rtdb.firebaseio.com//users/'+userToedit.id+'.json', user)
      .then((response) => {
        console.log(response);
        fetchUsers();
      })
  ...
  function fetchUsers(){
    ...
    axios.get('https://react-http-tutorial-2529c-default-rtdb.firebaseio.com//users.json')
    .then((response) => {
      console.log(response);
  ...
  function onDeleteUser(user){
    ...
    if(del){
      axios.delete('https://react-http-tutorial-2529c-default-rtdb.firebaseio.com//users/'+user.id+'.json')
      .then((response) => {
        console.log(response);
        fetchUsers();
      })
